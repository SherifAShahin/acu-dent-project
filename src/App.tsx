  ...
  return (
    ...
    >
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-emerald-50 text-emerald-700 text-xs font-black tracking-widest">
...
function TeamPage() {
  return (
    ...
    >
      ...
      <section className="bg-slate-900 rounded-[3rem] p-8 sm:p-12 text-white overflow-hidden relative">
        <div className="absolute top-0 right-0 w-72 h-72 bg-emerald-500/10 blur-[100px] rounded-full" />
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-[2rem] space-y-6">
            ...
            <ul className="space-y-4">
              <li className="flex items-center justify-between border-b border-white/5 pb-3">
                ...
                <span className="text-slate-400">مشروع تخرج</span>
              </li>
              <li className="flex items-center justify-between border-b border-white/5 pb-3">
                <span className="font-bold">المجال</span>
                <span className="text-slate-400">ذكاء اصطناعي طبي</span>
              </li>
              <li className="flex items-center justify-between border-b border-white/5 pb-3">
              ...
              <li className="flex items-center justify-between">
                ...
                <span className="text-slate-400">الأهرام الكندية</span>
              </li>
            </ul>
          </div>
        </div>
...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Nav */}
      <div className="md:hidden bg-white border-b border-slate-100 grid grid-cols-2 gap-2 p-3">
        {navItems.map((item) => (
          <button
            key={item.id}
            onClick={() => setActiveTab(item.id)}
